        ...
        <form onSubmit={handleSave} className="bg-white rounded-2xl border border-slate-200 p-8 shadow-2xs space-y-6">
          ...
          <div className="p-4 rounded-xl border border-slate-100 bg-slate-50/50 space-y-2">
            ...
            <input 
              ...
              className="w-32 px-3 py-1.5 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
            />
          </div>
          ...
          <div className="pt-4 flex justify-end">
            <button 
              type="submit"
              disabled={saving}
              className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl shadow-sm transition-all flex items-center gap-2 disabled:opacity-50"
            >
