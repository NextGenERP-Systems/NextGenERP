# ==============================================================================
# NextGen ERP - IAP Tunnel Helper for HRM Module Development
...
Write-Host "  Starting GCP IAP Tunnel for HRM Module -> $INSTANCE_NAME           " -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "Local port: $LOCAL_PORT -> Remote VM port: $REMOTE_PORT" -ForegroundColor Green
Write-Host "Target Database: nextgen_erp_hrm" -ForegroundColor Yellow
