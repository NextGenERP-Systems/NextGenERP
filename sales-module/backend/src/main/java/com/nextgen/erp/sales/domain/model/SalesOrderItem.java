...
public class SalesOrderItem {
    ...
    @Column(length = 100)
    @Builder.Default
    private String warehouse = "Main Warehouse";
    ...
    @Column(name = "billed_amt", precision = 15, scale = 2)
    @Builder.Default
    private BigDecimal billedAmt = BigDecimal.ZERO;

    @Column(name = "picked_qty", precision = 15, scale = 4)
    @Builder.Default
    ...
    @Column(name = "prevdoc_quotation_item_id")
    private UUID prevdocQuotationItemId;
}
