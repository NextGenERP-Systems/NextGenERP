        ...
        <header className="h-16 border-b border-white/60 bg-white/60 backdrop-blur-2xl px-8 flex items-center justify-between sticky top-0 z-20 shadow-2xs">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 pl-1">
              <div className="w-8 h-8 rounded-xl liquid-btn-primary flex items-center justify-center font-bold text-xs text-white shadow-xs">
                HR
              </div>
              <div className="text-left hidden sm:block">
                <div className="text-xs font-bold text-slate-900 leading-tight">HR Operations</div>
                <div className="text-[10px] text-slate-500 font-semibold">Enterprise Core</div>
              </div>
            </div>
          </div>
        </header>
