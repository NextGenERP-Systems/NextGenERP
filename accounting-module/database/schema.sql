...
-- Create Indexes for High Performance Ledger Querying
CREATE INDEX IF NOT EXISTS idx_gle_posting_date ON general_ledger_entries(posting_date);
CREATE INDEX IF NOT EXISTS idx_gle_account_id ON general_ledger_entries(account_id);
CREATE INDEX IF NOT EXISTS idx_gle_voucher ON general_ledger_entries(voucher_type, voucher_number);
...
CREATE INDEX IF NOT EXISTS idx_si_customer ON sales_invoices(customer_name);
CREATE INDEX IF NOT EXISTS idx_pi_supplier ON purchase_invoices(supplier_name);
